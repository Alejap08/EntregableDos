...
//------------------------------------------------------------------------------
  ...
  const nuevoUsuario = (nombre, email, password) => {
    ...
    {
     return "Los datos del usuraio son iguales, verificar"   
    }
    }
    console.log(nuevoUsuario("felipe","feli@gmail.com","1234"))
  //------------------------------------------------------------------------------------    
  ...
  console.log(actualizarPassword(0),1234))
